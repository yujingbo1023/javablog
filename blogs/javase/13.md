...
演示一下`getName()`、`setName(String name)`、`currentThread()`、`sleep(long time)`这些方法的使用效果。创建MyThread类，如下：
...
![1701757681173](./assets/1701757681173.png)
...
![1701759672635](./assets/1701759672635.png)
...
![1701759770357](./assets/1701759770357.png)
...
![1701759998653](./assets/1701759998653.png)
...
所谓生命周期就是线程从生到死的过程中间有哪些状态，以及这些状态之间是怎么切换的。在Thread类中有一个嵌套的枚举类叫Thread.Status，这里面定义了线程的6中状态。如下图所示

![1701760175573](./assets/1701760175573.png)
...
![1701760240742](./assets/1701760240742.png)
