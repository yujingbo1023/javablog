...
![1705475391575](./assets/1705475391575.png)
...
![1705475614472](./assets/1705475614472.png)
...
![1705475939399](./assets/1705475939399.png)
...
![1705476069524](./assets/1705476069524.png)

![1705476106633](./assets/1705476106633.png)

![1705476168336](./assets/1705476168336.png)

![1705476223203](./assets/1705476223203.png)

![1705476276733](./assets/1705476276733.png)
...
![1705476417502](./assets/1705476417502.png)
...
![1705476791332](./assets/1705476791332.png)
...
#### 2.3 第三步，创建SpringMVC配置类

创建配置类，设置配置类，扫描controller包，加载Controller控制器bean。一次性工作。

![1705476934362](./assets/1705476934362.png)
...
创建Tomcat的Servlet容器配置类，加载SpringMVC配置，并设置SpringMVC请求拦截路径。一次性工作。

![1705477471404](./assets/1705477471404.png)



```java
// 创建Tomcat的Servlet容器配置类，加载SpringMVC配置
// 并设置SpringMVC请求拦截路径
// web容器配置类
public class ServletContainersInitConfig extends AbstractDispatcherServletInitializer {
    // 加载springmvc配置类，产生springmvc的容器
    @Override
    protected WebApplicationContext createServletApplicationContext() {
        // 创建springmvc容器
        AnnotationConfigWebApplicationContext ctx = new AnnotationConfigWebApplicationContext();
        ctx.register(SpringMvcConfig.class); // 加载指定的配置类
        return ctx;
    }

    // 设置springmvc控制器处理的请求路径
    @Override
...
- AbstractDispatcherServletInitializer提供三个接口方法供用户实现
  - createRootApplicationContext()方法，如果创建Servlet容器时需要加载非SpringMVC对应的bean，使用当前方法进行，使用方式同createServletApplicationContext()。说白了，createRootApplicationContext用来加载Spring环境
  - createServletApplicationContext()方法，创建Servlet容器时，加载SpringMVC对应的bean并放入WebApplicationContext对象范围中，而WebApplicationContext的作用范围为ServletContext范围，即整个web容器范围。说白了，createServletApplicationContext用来加载SpringMVC环境
...
![1705477659920](./assets/1705477659920.png)

还有一种运行方式：

![1705477794789](./assets/1705477794789.png)



![1703670982814](./assets/1703670982814.png)
...
![1705477740230](./assets/1705477740230.png)

![1705477812830](./assets/1705477812830.png)
...
![1705478078548](./assets/1705478078548.png)
...
1. 服务器启动，执行ServletContainersInitConfig类，初始化web容器
   ...
   ![1705478195840](./assets/1705478195840.png)

2. 执行createServletApplicationContext方法，创建了WebApplicationContext对象

   - 该方法加载SpringMVC的配置类SpringMvcConfig来初始化SpringMVC的容器

     ![1705478297127](./assets/1705478297127.png)

3. 加载SpringMvcConfig配置类

   ![1703671324855](./assets/1703671324855.png)

4. 执行@ComponentScan加载对应的bean

   - 扫描指定包下所有类上的注解，如Controller类上的@Controller注解

     ![1705478417936](./assets/1705478417936.png)

5. 加载UserController，每个@RequestMapping的名称对应一个具体的方法

   - 此时就建立了 `/save` 和 save方法的对应关系

     ![1705478503168](./assets/1705478503168.png)

6. 执行getServletMappings方法，定义所有的请求都通过SpringMVC

   - `/`代表所拦截请求的路径规则，只有被拦截后才能交给SpringMVC来处理请求

     ![1703671402480](./assets/1703671402480.png)
...
入门案例的内容已经做完了，在入门案例中我们创建过一个`SpringMvcConfig`的配置类，再回想前面咱们学习Spring的时候也创建过一个配置类`SpringConfig`。这两个配置类都需要加载他们对应的bean，那么它们分别都需要加载哪些内容?



现在我们项目的目录结构如下：

![1703671516153](./assets/1703671516153.png)
...
![1703671674004](./assets/1703671674004.png)
...
- 方式一:Spring加载的bean设定扫描范围为com.malu,排除掉controller包中的bean
  ...
  ![1703671776634](./assets/1703671776634.png)

- 方式二:Spring加载的bean设定扫描范围为精准范围，例如service包、dao包等

  ![1703671753515](./assets/1703671753515.png)
...
![1705547941052](./assets/1705547941052.png)



pom.xml添加Spring依赖

![1705547990964](./assets/1705547990964.png)
...
![1705548032241](./assets/1705548032241.png)

![1705548073823](./assets/1705548073823.png)

![1705548117310](./assets/1705548117310.png)
...
![1705548413796](./assets/1705548413796.png)

![1705548191432](./assets/1705548191432.png)

![1705548327089](./assets/1705548327089.png)

![1705548365799](./assets/1705548365799.png)

![1705548462082](./assets/1705548462082.png)
...
![1705548496087](./assets/1705548496087.png)



设置bean加载控制方式一：修改Spring配置类，设定扫描范围为精准范围。

![1705548559135](./assets/1705548559135.png)
...
![1705548746484](./assets/1705548746484.png)
...
如果SpringConfig，直接扫描com.malu包，如下：

![1705548870004](./assets/1705548870004.png)



设置bean加载控制方式二：修改Spring配置类，设定扫描范围为com.malu,排除掉controller包中的bean

![1705549008651](./assets/1705549008651.png)
...
- 如果不去掉SpringMvcConfig中的@Configuration的话，就不会报错，原因如下：
...
![1705549450604](./assets/1705549450604.png)
...
![1705549592278](./assets/1705549592278.png)
...
![1705479916452](./assets/1705479916452.png)
...
![1705479966898](./assets/1705479966898.png)

![1705480000219](./assets/1705480000219.png)

```java
// springmvc的配置类，本质还是spring的配置类
@Configuration
@ComponentScan("com.malu.controller")
public class SpringMvcConfig {
}
...
![1705480090049](./assets/1705480090049.png)

![1705480113864](./assets/1705480113864.png)
...
![1705480235801](./assets/1705480235801.png)
...
![1705480310110](./assets/1705480310110.png)

![1705480335629](./assets/1705480335629.png)
...
![1705480464028](./assets/1705480464028.png)
...
![1705480536949](./assets/1705480536949.png)

![1705480565357](./assets/1705480565357.png)
...
![1705480629739](./assets/1705480629739.png)
...
![1705480775951](./assets/1705480775951.png)



pom.xml同第1小节中的pom.xml文件中的内容。说白了，不变的。
...
![1705480937153](./assets/1705480937153.png)
...
![1705481018940](./assets/1705481018940.png)

![1705481058477](./assets/1705481058477.png)
...
![1705481193455](./assets/1705481193455.png)
...
![1705481350947](./assets/1705481350947.png)
...
![1705481515051](./assets/1705481515051.png)



POST发送表单数据：

![1705481684986](./assets/1705481684986.png)
...
![1705481748072](./assets/1705481748072.png)



解决方案:配置过滤器

![1705481909328](./assets/1705481909328.png)
...
![1705482071410](./assets/1705482071410.png)
...
public class UserController {
    ...
    @RequestMapping("/commonParam")
    @ResponseBody
    public String commonParam(String userName,String age){
...
![1705482196172](./assets/1705482196172.png)
...
![1705482282182](./assets/1705482282182.png)
...
![1705482394492](./assets/1705482394492.png)
...
![1705482542576](./assets/1705482542576.png)
...
![1705482618838](./assets/1705482618838.png)

![1705482685354](./assets/1705482685354.png)
...
```url
http://localhost/pojoContainPojoParam?name=malu&age=18&address.city=zz&address.province=hn
```
...
![1705482883186](./assets/1705482883186.png)



测试post请求：

![1705482998297](./assets/1705482998297.png)
...
![1705483756371](./assets/1705483756371.png)



post请求测试：

![1705483839866](./assets/1705483839866.png)
...
![1705484002392](./assets/1705484002392.png)
...
![1705484071231](./assets/1705484071231.png)
...
- json普通数组（["value1","value2","value3",...]）  ["aaa","bbb","ccc"]
- json对象（{key1:value1,key2:value2,...}）  {"a":"1","b":"2","c":"3"}
- json对象数组（[{key1:value1,...},{key2:value2,...}]）  [{"name":"wc","age":1},{"name":"xq","age":2}]
...
1. SpringMVC默认使用的是jackson来处理json的转换，所以需要在pom.xml添加jackson依赖
   ...
   ![1705484356007](./assets/1705484356007.png)
...
2. PostMan发送JSON数据
   ...
   ![1705484432166](./assets/1705484432166.png)

   

3. 在SpringMVC的配置类中开启SpringMVC的注解支持，这里面就包含了将JSON转换成对象的功能。

   ![1705484482552](./assets/1705484482552.png)
...
4. 参数前添加@RequestBody
   ...
   ![1705484579821](./assets/1705484579821.png)
...
5. 启动运行程序
   ...
   ![1705484640488](./assets/1705484640488.png)
...
![1705484773684](./assets/1705484773684.png)
...
![1705484821464](./assets/1705484821464.png)
...
![1705484914923](./assets/1705484914923.png)
...
3. 通过打印，我们发现SpringMVC可以接收日期数据类型，并将其打印在控制台。
   ...
   ![1705541387549](./assets/1705541387549.png)
...
5. 使用PostMan发送请求，携带两个不同的日期格式，
   ...
   ```url
   http://localhost/dateParam?date=2088/08/08&date1=2088-08-08
   ```
...
6. 发送请求和数据后，页面会报400，控制台会报错一个错误。从错误信息可以看出，错误的原因是在将`2088-08-08`转换成日期类型的时候失败了，原因是SpringMVC默认支持的字符串转日期的格式为`yyyy/MM/dd`,而我们现在传递的不符合其默认格式，SpringMVC就无法进行格式转换，所以报错。
   ...
   ![1705541637413](./assets/1705541637413.png)
...
8. 重新启动服务器，重新发送请求测试，SpringMVC就可以正确的进行日期转换了
   ...
   ![1705541744660](./assets/1705541744660.png)
...
11. 重新启动服务器，重新发送请求测试，SpringMVC就可以将日期时间的数据进行转换
    ...
    ![1705541893483](./assets/1705541893483.png)
...
![1705542157559](./assets/1705542157559.png)



pom.xml添加Spring依赖

![1705542195044](./assets/1705542195044.png)
...
![1705542320000](./assets/1705542320000.png)
...
![1705542365419](./assets/1705542365419.png)
...
![1705542414222](./assets/1705542414222.png)
...
2. 步骤2:启动程序测试
   ...
   ![1705542516031](./assets/1705542516031.png)
...
2. 步骤2:启动程序测试，此处不涉及到页面跳转，可以使用浏览器也可以使用PostMan进行测试，输入地址`http://localhost/toText`访问

   ![1705542687720](./assets/1705542687720.png)

   ![1705542766331](./assets/1705542766331.png)
...
![1705542925848](./assets/1705542925848.png)
...
![1705543067239](./assets/1705543067239.png)
...
- 写在类上就是该类下的所有方法都有@ReponseBody功能
  ...
  ![1705543294024](./assets/1705543294024.png)
...
![1705543735483](./assets/1705543735483.png)
...
![1705543812135](./assets/1705543812135.png)

![1705543857310](./assets/1705543857310.png)
...
![1705543939084](./assets/1705543939084.png)

![1705544234521](./assets/1705544234521.png)
...
![1705544541322](./assets/1705544541322.png)
...
![1705545324361](./assets/1705545324361.png)



如果方法形参的名称和路径`{}`中的值不一致，该怎么办?

![1705545504232](./assets/1705545504232.png)

![1705545552391](./assets/1705545552391.png)



如果有多个参数需要传递该如何编写?前端发送请求的时候使用:`http://localhost/users/1/tom`,路径中的`1`和`tom`就是我们想要传递的两个参数。后端获取参数，需要做如下修改:

![1705545653860](./assets/1705545653860.png)
...
![1705545750715](./assets/1705545750715.png)
...
![1705545834368](./assets/1705545834368.png)
...
![1705545887257](./assets/1705545887257.png)
...
![1705545974554](./assets/1705545974554.png)
...
![1705546362824](./assets/1705546362824.png)
...
![1705546434867](./assets/1705546434867.png)
...
![1705546817741](./assets/1705546817741.png)
...
public class BookController {
    ...
    public List<Book> getAll(){
        ...
        Book book1 = new Book();
        book1.setType("计算机");
        book1.setName("vue3从入门到精通");
        book1.setDescription("vue3精讲图书");
        bookList.add(book1);

        Book book2 = new Book();
        book2.setType("计算机");
        book2.setName("vue2从入门到精通");
        book2.setDescription("vue2精讲图书");
        bookList.add(book2);

        Book book3 = new Book();
        book3.setType("计算机");
        book3.setName("vue1从入门到精通");
        book3.setDescription("vue1精讲图书");
        bookList.add(book3);
...
![1705546929286](./assets/1705546929286.png)



测试查询

![1705546962854](./assets/1705546962854.png)
...
1. 还是前面的项目
   ...
   ![1705559018406](./assets/1705559018406.png)

   

2. 添加依赖和插件

   ![1705559109733](./assets/1705559109733.png)
...
3. Spring整合Mybatis
   ...
   ![1705559189355](./assets/1705559189355.png)
   ...
   ![1705559230055](./assets/1705559230055.png)
   ...
   ![1705559334130](./assets/1705559334130.png)
   ...
   ![1705559389331](./assets/1705559389331.png)
   ...
   ![1705559463053](./assets/1705559463053.png)
...
4. Spring整合SpringMVC
   ...
   ![1705559500654](./assets/1705559500654.png)
   ...
   ![1705559571021](./assets/1705559571021.png)
...
1. Book实体类
   ...
   ![1705559627411](./assets/1705559627411.png)
...
2. BookDao接口
   ...
   ![1705559815688](./assets/1705559815688.png)
...
1. BookService接口
   ...
   ![1705559909968](./assets/1705559909968.png)
...
2. BookServiceImpl实现类
   ...
   ![1705560171122](./assets/1705560171122.png)
...
![1705560460746](./assets/1705560460746.png)
...
![1705560658893](./assets/1705560658893.png)
...
![1705560750947](./assets/1705560750947.png)



![1705560776613](./assets/1705560776613.png)



![1705560802347](./assets/1705560802347.png)

![1705560815976](./assets/1705560815976.png)



![1705560877893](./assets/1705560877893.png)

![1705560888917](./assets/1705560888917.png)



![1705560935536](./assets/1705560935536.png)

![1705560946332](./assets/1705560946332.png)
...
![1705561281462](./assets/1705561281462.png)
...
![1705561449609](./assets/1705561449609.png)
...
![1705561536375](./assets/1705561536375.png)
...
![1705561840582](./assets/1705561840582.png)
...
![1705561922438](./assets/1705561922438.png)
...
![1705563447149](./assets/1705563447149.png)
...
![1705563949090](./assets/1705563949090.png)
...
![1705564332683](./assets/1705564332683.png)
...
![1705564373551](./assets/1705564373551.png)
...
![1705564423711](./assets/1705564423711.png)
...
![1705564542384](./assets/1705564542384.png)
...
public class BookServiceImpl implements BookService {
    ...
    public Book getById(Integer id) {
        //模拟业务异常，包装成自定义异常
        if(id <0){
            throw new BusinessException(Code.BUSINESS_ERR,"你传递的id不能是负数!");
        }
    }
}
```
...
![1705564785967](./assets/1705564785967.png)
...
![1705564835907](./assets/1705564835907.png)
...
1. 【第一步】定义拦截器，定义一个类，实现HandlerInterceptor接口即可
   ...
   ![1705565287077](./assets/1705565287077.png)
...
2. 【第二步】配置加载拦截器
   ...
   ![1705565664327](./assets/1705565664327.png)

   ![1705565557189](./assets/1705565557189.png)
...
![1705565733617](./assets/1705565733617.png)
