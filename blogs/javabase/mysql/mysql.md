...
- https://cloud.tencent.com/developer/article/2398012
...
在实际设计中，要整体遵循范式理论。如果在某些特定的情况下还死死遵循范式也是不可取的，因为可能降低数据库的效率，此时可以适当增加冗余而提高性能
...
- 第二范式（2NF）：不存在部分依赖
  ...
  ![1718271020444](./assets/1718271020444.png)

- 第三范式（3NF）：不存在间接依赖

  ![1718271081791](./assets/1718271081791.png)
...
设计关系数据库的一个重要部分是将数据元素划分为相关的表，我们可以根据数据本身的关联性，将不同表之间的数据聚合在一起。无论在表与表之间建立了什么样的关系，决定数据之间是否有关系的不是表，而是数据本身。
...
![1718271419436](./assets/1718271419436.png)



一对多关系是建立在两张表之间的关系。一个表中的一条数据可以对应另一个表中的多条数据。可以添加外键约束保证数据的参照完整性，外键永远在多方。外键允许重复，允许含有空值。如果添加的外键约束，那么删除数据时，一定是先删除有外键一方的数据。



操作：

![1718329902127](./assets/1718329902127.png)

![1718329955069](./assets/1718329955069.png)

![1718330044077](./assets/1718330044077.png)



![1718330082736](./assets/1718330082736.png)

![1718331430128](./assets/1718331430128.png)

![1718331479669](./assets/1718331479669.png)
...
![1718271771926](./assets/1718271771926.png)

一对一关系是建立在一对多的基础之上，一个表中的一条数据只能对应另一个表中的一条数据。可以添加外键约束保证数据的参照完整性，外键可以在任何一方，需要让外键具备唯 一约束。

![1718331836036](./assets/1718331836036.png)

![1718331988424](./assets/1718331988424.png)

![1718332031805](./assets/1718332031805.png)
...
![1718271956224](./assets/1718271956224.png)

操作：

![1718332192221](./assets/1718332192221.png)

![1718332250466](./assets/1718332250466.png)



![1718332605878](./assets/1718332605878.png)

![1718332786282](./assets/1718332786282.png)



![1718332869082](./assets/1718332869082.png)



![1718332947788](./assets/1718332947788.png)



![1718332975657](./assets/1718332975657.png)



![1718333285701](./assets/1718333285701.png)

![1718333362261](./assets/1718333362261.png)
...
- 将姓名为灭绝师太的性别修改为‘女’，生日改为‘1970-02-02’
- 删除杨逍
- 查询学生表显示所有数据
-  求每个学生的名字，列别名为“姓名”
- 求名字为张无忌的个人信息
...
- 查询"张"姓学生的数量
- 查询没学过"admin"老师授课的同学的信息
- 查询学过“1”并且也学过编号“2”课程的同学的学号、姓名；
- 查询“Java”课程比“前端”课程成绩高的所有学生的学号
- 查询有课程成绩小于60分的同学的学号、姓名；
- 查询所有同学的学号、姓名、选课数、总成绩；
- 查询至少学过学号为“1”同学所学课程中任意一门课的**其他同学**学号和姓名；
- 查询男生、女生的人数；
