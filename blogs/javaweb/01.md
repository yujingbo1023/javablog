...
```mysql
-- 给指定列添加数据
INSERT INTO stu (id, NAME) VALUES (1, 'wc');

-- 给所有列添加数据
INSERT INTO stu (id,NAME,sex,birthday,score,email,tel,STATUS) VALUES (2,'malu','男','1999-11-11',88.88,'lisi@qq.cn','13888888888',1);
